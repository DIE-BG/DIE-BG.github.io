...
## Introducción
La presentación contiene las principales conclusiones de la *revisión literaria, análisis matemáticos y propuesta práctica del DIE* relacionadas al método de validación por bloques HV **($\text{HV block}$)**.
...
Lo anterior sugiere algunos rangos plausibles para los valores de $H$, pero con el fin de fundamentar de mejor manera la propuesta de un rango de valores se muestran un conjunto de graficas que identifican la posición de los valores de $H$ en los rangos intercuartílicos de las variables objetivo.
...
Lo anterior da mayor sustento a nuestra propuesta, la cual es utilizar el rango de valores de 6 a 14.^[Al igual que @burman1994cross centramos nuestra elección en el horizon 1 de pronóstico]
...
## Resultados para el Coeficiente de variación
![](images/hv_exercise/ComparativeDispersion.png)

## Resultados para el RMSE
