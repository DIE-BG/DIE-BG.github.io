...
2. Establecer un valor plausible (o un conjunto de valores) para el parámetro $H$ en el método de validación $HV$ con el propósito de su posterrior implementación en la metodología de Selección de Modelos del DIE.
