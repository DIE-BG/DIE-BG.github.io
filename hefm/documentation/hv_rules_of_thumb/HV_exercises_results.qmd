...
# 1. Determinación del tamaño mínimo de estimación

#
La determinación del tamaño mínimo de la muestra de estimación tiene dos grandes implicaciones dentro del método de validación por bloques $HV$: en primera instancia un número relativamente pequeño aumenta el número de submuestras posibles y, en segunda instancia, una vez definido el tamaño mínimo de muestra automáticamente se define el valor máximo que puede tomar el parámetro $H$ dentro del método $HV$.
