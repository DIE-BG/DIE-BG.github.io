...
+ Pese a que el ejercicio se construyó teniendo de referencia un modelo específico, la elección del parámetro $H$ no depende de un modelo específico, más bien **depende de la relación de dependencia temporal entre las series utilizadas**.
...
1. $H$ en un rango de *4 a 20* con pasos de 4. Esto implica que los valores de $H$ utilizados remueven años completos de observaciones a cada lado del conjunto de validación.
